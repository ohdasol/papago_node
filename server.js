...
app.post("/detectLangs", (req, res) => {
  ...
  request.post(options, (error, response, body) => { 
    if (!error && response.statusCode == 200) {
      ...
      // "ko", targetLanguage, query 넘기기
      // "ko"는 parseBody의 langCode에 들어있음
...
// papagp 번역 요청 부분.
// 언어가 입력되면 redirect를 통해서 translate로 감
